...
public class PanelLoginRegister extends javax.swing.JLayeredPane {
    ...
    private void initLogin(ActionListener eventLogin) {
        ...
        swing.Button cmdRFID = new swing.Button();
        cmdRFID.setBackground(new Color(132, 132, 215));
        cmdRFID.setForeground(new Color(255, 255, 255));
        cmdRFID.addActionListener(eventLogin);
        cmdRFID.setText("SIGN IN WITH RFID");
        login.add(cmdRFID, "w 40%, h 40");
        cmdRFID.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Component source = (Component) e.getSource();
                JFrame mainFrame = (JFrame) SwingUtilities.getWindowAncestor(source);
                RFIDLogin rfidLogin = new RFIDLogin(new JFrame(), true);
